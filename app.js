const STORAGE_KEY = 'cupula_brief_leko_form_v2';
...
function exportFilledHtml() {
  ...
  const opt = {
    margin: [10, 10, 10, 10],
    filename: 'Brief_LEKO_Completado.pdf',
  ...
  html2pdf().set(opt).from(clone).save()
    .then(() => {
      ...
      showModal(
        'Descarga completada',
        'Se ha descargado el archivo "Brief_LEKO_Completado.pdf" con todas sus respuestas. Puede enviarlo directamente a Cúpula Systems.',
